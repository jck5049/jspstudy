...
public class BindingServlet1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 	...
		 	2. binding
		 		...
		 		4) 속성(Attribute) 관련 메소드
		 			(1) getAttribute('속성') 	 : 속성 값 가져오기 (캐스팅이 필요할 수 있다.)
		 			(2) setAttribute('속성', 값) : 속성 값 저장하기 (Object 타입으로 저장한다.)
		 			(3) removeAttribute('속성')  : 속성 값 제거하기
		...
		// 1. HttpServletRequest의 전달이 없는 이동 : redirect, <a href="">, (자바스크립트)location.href=""
