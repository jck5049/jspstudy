<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%> <%-- prefix : (c:) 앞에다 고정 suffix: (c:) 뒤에다 고정  --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<%--
		...
		3. 형식
			방법 1) <c:set var="속성명" value="값" scope="영역"></c:set>
			방법 2) <c:set var="속성명" value="값" scope="영역" /> *권장*
		4. 예시
	...
	<c:set var="height" value="1.79" scope="page" />
	<c:set var="weight" value="97" scope="page" />
